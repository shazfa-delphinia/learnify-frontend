...
class EcoWellnessSignupForm {
  constructor() {
    ...
    if (!this.form) return; // kalau bukan halaman signup, jangan jalan
  ...
  async handleSubmit(e) {
    ...
    try {
      ...
      // Pakai NODE_API_URL (di-define di HTML)
      const baseUrl =
        typeof NODE_API_URL !== "undefined"
          ? NODE_API_URL
          : "https://learnify-backend-2exd.onrender.com";
      ...
      // Redirect ke sign in (masih di folder auth)
      ...
      if (
        ...
        errorMessage =
          "Tidak bisa terhubung ke server. Pastikan backend sudah jalan (Render).";
